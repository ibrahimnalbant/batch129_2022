    ...
    */
    ...
    public static void printEvenElements2(List<Integer> nums){
            ...
            nums. //12 9 131 14 9 10 4 12 15
                stream().
                filter(t ->t%2==0).
                forEach(t -> System.out.print(t + " "));    // bu duzende yazmak daha dogru
     */
...
// aralarina bosluk koyarak yazdiran method'u olusturunuz.(Functional)
    ...
    public static void printCubeOfDistinctOddElements(List<Integer>nums){
        nums.
                stream().//List Yapisini Stream Yapisina Cevirdik. Dikey Oldu
                filter(t->t%2!=0).//tek sayilari aldik
                distinct().// Sayilarin tekrarli olanlarini attik
                map(t->t*t*t).//Kupunu aldik
                forEach(t-> System.out.print(t+" "));//729 2248091 3375

    }

    //7)Create a method to calculate the "sum" of the "squares" of "distinct" "even" elements.(functional)
...
//3.Yol:
    ...
    //11)Create a method to find the minimum value which is greater than 7 and even from the list
        //   12 9 131 14 9 10 4 12 15 ==> 10 <-- List'te 7 den buyuk en kucuk cift sayi
