...
public class CoursesRunner {
    public static void main(String[] args) {
        ...
        //Java eksik kaiplarin object uretmesine musaade etmez.
        //Bu yuzden, "abstract class" lardan object uretilemez.

        //"abstract class" larin constructor'i vardir ama bu constructor object uretemez

        //Courses myCourse = new Courses();  //  burasi hata verdirir.
