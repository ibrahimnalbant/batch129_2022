...
public class MethodCreation01 {
    ...
    public static void main(String[] args)  {
        ...
        long dikdortgenAlan = multiply(3, 8);
        System.out.println(dikdortgenAlan);

        int dikdotgenCevre = add(6,10) * 2;
        System.out.println(dikdotgenCevre);
    ...
    static double getCube(double a){
        ...
        //1)Dikdirtgenin alanini hesaplayan methodu olusturunuz ve kullaniniz
            // dikdortgenAlan a*b dir. bu method yukarıda tanımlanmıstı.

        //2)Dikdirtgenin cevresini hesaplayan methodu olusturunuz ve kullaniniz
            // dikdortgenCevre (a+b)*2 dir. bu toplama method yukarıda tanımlanmıstı.
