package day26overriding;
    ...
    4) Overriding'de parent class'daki method'a "Overridden Method", child class'daki method'a "Overriding Method" denir.
    5) "private" Method'lar "override" edilemezler.
    6) Child class'daki override edilmis method (Overriding Method)' un access modifier'i
        Parent Class'daki override edilmis method (overridden method)' un access modifier'indan dar olamaz.
        ...
        Overridden Method ==> default ise Overriding Method ==> override olmaz ki access modifier'i olsun. (Bkz 5. kural)
    ...
    8) Method'un return type'i "primitive" ise, Overriding yaparken return type degistirilemez. Cunku;
        return type ya ayni olur veya parent'dan secilir ama primitive'ler arasinda "parent-child iliskisi"
        olmadigindan parent'dan secmek mevzu bahis olamaz. O zaman tek secenek aynisi olmalidir kalir.
    9) Method'un return type'i "Wrapper Class" ise, Overriding yaparken return type degistirilemez.
        Cunku; return type ya ayni olur veya parent'dan secilir, ama Java bir wrapper class'i digerinin
        parent'i yapmadigindan parent'dan secme ihtimali yoktur, geriye sadece aynisi olma ihtimali kalir.
