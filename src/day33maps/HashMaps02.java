...
public class HashMaps02 {
    public static void main(String[] args) {
        ...
        //Exm.1: Size verilen bir cumledeki herbir kelimenin kacar kere kullanildigini gosteren kodu yaziniz.
        ...
        for (String w : wordsArray){
            ...
            if (numOfOccurrence==null){
                ...
                wordsMap.replace(w, numOfOccurrence+1); // put() da kullanilabilir
            }
        }
