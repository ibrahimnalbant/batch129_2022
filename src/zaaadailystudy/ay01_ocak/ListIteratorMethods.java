...
public class ListIteratorMethods {
	 ...
	 * MUTLAKA KES�NL�KLE hasNext() ve next(); method'lari calistirilarak cursor(pointer) en sona getirilmeli
	...
	public static void main(String[] args) {
		...
		// list�terator interfaceden lt1 veriable creat edildi. Degeri listten assingn edildi...
