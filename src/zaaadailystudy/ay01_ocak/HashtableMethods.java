...
public class HashtableMethods {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 1-size() ; Bu karma tablodaki anahtar say�s�n� dondurur.
		...
		// 2-clone() ; Bu karma tablonun rastgele bir kopyas�n� olusturur.
        ...
        // defaultValue bu esleme key i�in esleme icermiyorsa dondurur...
		...
		// 11-isEmpty() ; Bu hashtable'�n degerlerle key eslemedigini test eder bos ise true dolu ise false dondurur.
