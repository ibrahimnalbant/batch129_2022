...
public class Lambda03 {
    ...
    Course courseEnglishNight = new Course("Winter", "English Night", 93, 144);
        ...
        //Ex1:Tum "averageScore" larin 91 den buyuk olup olmadigini kontrol eden kodu yaziniz.
        boolean result1 = coursesList.stream().allMatch(t->t.getAverageScore()>91);
        System.out.println(result1);

        //Ex2:Kurs isimlerinden en az birinin "Turkish" kelimesini icerip icermedigini kontrol eden kodu yaziniz.
        boolean result2 = coursesList.stream().anyMatch(t->t.getCourseName().contains("Turkish"));
        System.out.println(result2);

        //Ex3:Average scoru'u en yuksek olan kursun ismini console'a yazdiran kodu yaziniz.
        ...
        //Ex4:Tum course object'lerini average score'a gore kucukten buyuge diziniz
        ...
        //Ex5: Tum course object'lerini average score'a gore kucukten buyuge diziniz
