...
/*
1)Bir interface'i bir Class'in parent'i yapmak icin "impliments" keyword'unu kullaniniz.
...
3) Coklu interface parent 'larin icine ayni isimli method'lar koyabiliriz.
    Mesela Ac'nin, Engine'nin ve Securty'nin iclerine "run()" koymak gibi.
...
public class Civic implements Ac, Engine, Security {
   ...
   @Override
    ...
    @Override
    public void run() { System.out.println("Ac runs perfectly");
